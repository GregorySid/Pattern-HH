...
class FavouritesAdapter @Inject constructor(val listner: (DataVacancie) -> Unit):
    ListAdapter<DataVacancie, FavouritesAdapter.ViewHolder>(Comp()) {
    ...
    class ViewHolder(view: View, val listner: (DataVacancie) -> Unit): RecyclerView.ViewHolder(view) {
